...
export default function PegawaiDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-blue-100 p-10">
      {/* Header */}
      <div className="mb-10 text-center">
        ...
        {/* Garis bawah animasi */}
        <div className="mt-4 h-1 w-32 mx-auto bg-gradient-to-r from-indigo-500 to-blue-400 rounded-full"></div>
      </div>
        ...
        <div className="group relative bg-white rounded-2xl shadow-lg border border-green-100 hover:shadow-2xl transition-all hover:-translate-y-1 overflow-hidden">
          ...
          <div className="relative p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800">Daftar Berkas</h3>
            </div>
            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
            ...
            <Link
              to="/pegawai-berkas"
              className="inline-block px-4 py-2 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 transition"
            >
              Lihat Berkas
            </Link>
          </div>
      ...
      {/* Info Box */}
      <div className="mt-14 bg-white p-8 rounded-2xl border-l-4 border-indigo-500 shadow-lg hover:shadow-xl transition-all">
      ...
      {/* Footer Info */}
      <footer className="text-center mt-14 text-gray-500 text-sm border-t pt-6">
        <div className="flex flex-col items-center justify-center space-y-1">
          <p className="flex items-center gap-2">
            💻 Sistem ini dikembangkan oleh{" "}
            <span className="font-semibold text-indigo-700">Dea Ika Saskia</span>
          </p>
          <p>
            🕒 Last Update:{" "}
            <b>
